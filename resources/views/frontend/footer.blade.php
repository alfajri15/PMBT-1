<!-- Footer-->
<footer class="footer text-center bg-gradient-primary-to-secondary py-5">
            <div class="container">
                <div class="row">
                    <!-- Footer Location-->
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <img src="{{asset('foto/Logo_petikJombang&YBM_PLN.png' )}}" alt="" width="50%" bgcolor="white">
                        <br/>
                        <br/>
        ...
        <!-- Copyright Section-->
        <div class="copyright cont py-4 text-center text-white">
            <div ><small>PMB Pesantren PeTIK Jombang, All rights reserved <i>Express Project</i> </small></div>
        </div>
